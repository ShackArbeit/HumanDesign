     ...
     <div className={style.bookingEntranceListsContainer}>
      ...
      >
        ...
        <CardContent>
          ...
          <Typography sx={{ textAlign:"left"}} className={style.bookingItems}>
          <svg viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg" style={{width:"25px",height:"25px"}}>
          ...
          <span>中文</span>
          <svg width="25px" height="25px" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" fill="#00AFF0">
							<g>
          ...
          <Typography variant="body2" className={style.bookingItems}>
          <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="12" cy="12" r="10"></circle>
          <polyline points="12 6 12 12 16 14"></polyline>
          </svg>
          <span>60分鐘</span>
          <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 300 300" fill="currentColor">
        ...
        <Item className={style.bookingItemsButtonContainer}>
